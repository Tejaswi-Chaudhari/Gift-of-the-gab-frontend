...
const History = () => {
    ...
    const loadHistory = async () => {
        const result = await axios.get(`https://giftofthegab.pythonanywhere.com/api/history/${id}`);
        setHistory(result.data);
        const output = await axios.get(`https://giftofthegab.pythonanywhere.com/api/count/${id}`);
    ...
    console.log(history, history[0], typeof(history))
